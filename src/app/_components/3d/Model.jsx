...
import useMouse from "@simple/app/_utils/useMouse";
import useDimension from "@simple/app/_utils/useDimension";
import { projects } from "@simple/app/_components/3d/data";
...
export default function Model({ activeMenu }) {
  ...
  useEffect(() => {
    if (activeMenu != null) {
      plane.current.material.uniforms.uTexture.value = textures[0];
      animate(opacity, 1, {
        duration: 0.2,
        onUpdate: (latest) =>
